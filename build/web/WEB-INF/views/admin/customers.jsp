...
<head>
    ...
    <title>Customer Management - HRC Admin</title>
    ...
    <div class="container">
                    ...
                    <div class="col-12">
                        <div class="customer-card">
                            ...
                            <div class="customer-actions">
                                <button class="btn-edit" onclick="editCustomer(${customer.id}, '${customer.email}', '${customer.fullName}', '${customer.phone}')">
                                ...
                                <form action="${pageContext.request.contextPath}/admin/customers" method="post" style="display: inline;">
                                    ...
                                    <button type="submit" class="btn-reset" onclick="return confirm('Reset password to: customer123?')">
                                ...
                                <form action="${pageContext.request.contextPath}/admin/customers" method="post" style="display: inline;">
                                    ...
                                    <input type="hidden" name="customerId" value="${customer.id}">
                                    <button type="submit" class="btn-delete" onclick="return confirm('Are you sure you want to delete this customer?')">
        ...
        <c:if test="${empty customers}">
            <div class="text-center py-5">
                ...
                <p class="text-muted">Create your first customer to get started</p>
            </div>
        </c:if>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="bi bi-plus-circle"></i> Create New Customer</h5>
